    ...
    :QDialog( parent), _updateChecker(checker)
{
    ...
    connect(&_updateChecker, SIGNAL(error(QNetworkReply::NetworkError)), this, SLOT(errorOccured(QNetworkReply::NetworkError)));
