...
QString head=QString::fromUtf8("<b>Texmaker ")+TexmakerVersion::getCurrentVersion().toString()+QString::fromUtf8("</b><br>(compiled with Qt ")+QLatin1String(QT_VERSION_STR);
#if !defined(OLDPOPPLER)
